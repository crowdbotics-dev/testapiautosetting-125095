...
## Project Structure
    ...
    ├── testapiautosetting_125095  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125095`
...
2. Clone this repo and `cd testapiautosetting_125095`
